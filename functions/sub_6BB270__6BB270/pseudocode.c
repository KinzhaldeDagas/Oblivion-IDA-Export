double __cdecl sub_6BB270(float a1, float *a2, int a3, int a4, int *a5, unsigned __int8 a6)
{
  double v6; // st7
  float *v7; // ebx
  unsigned int v8; // edi
...
LABEL_13:
  ...
  {
    v11 = (float *)((char *)a2 + v10 * a6);
    v12 = (float *)((char *)a2 + a6 * (a4 + 3));
    v13 = (float *)((char *)a2 + a6 * (a4 + 2));
    v14 = 4 * a6;
    v28 = (float *)((char *)a2 + a6 * (a4 + 4));
    while ( 1 )
    {
      v22 = *v11;
      v15 = v22;
...
LABEL_18:
  ...
  *(float *)&a4 = (v6 - v27) / (v15 - v27);
  (*(void (__cdecl **)(int, char *, unsigned int, int *))(4 * a3 + 0xB3CFF8))(a4, v19, (unsigned int)v7 + v10 * a6, &a4);
  result = *(float *)&a4;
  *a5 = v18;
  return result;
}
