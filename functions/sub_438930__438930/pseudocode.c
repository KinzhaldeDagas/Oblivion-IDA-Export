LockFreeMap *__thiscall sub_438930(LockFreeMap *this, unsigned int a2, unsigned int a3, UInt32 a4)
{
  void *v5; // eax
  void *v6; // edi
  ...
  this->vtbl = &LockFreeMap<TESObjectREFR *,NiPointer<QueuedReference>>::`vftable';
