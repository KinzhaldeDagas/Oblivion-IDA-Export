unsigned int __thiscall sub_6E3F20(void *this, unsigned __int16 *a2)
{
  ...
  sub_6EC460(this, a2);
  v4 = (unsigned __int16 *)TESOutput_PrintString(*(_DWORD *)dword_B3E2D0);
  end = v2->end;
  ...
  v7 = (unsigned __int16 *)sub_7093D0((float *)this + 3, (int)"m_kColorValue");
  v8 = v2->end;
  v9 = v2->capacity;
  a2 = v7;
  if ( v8 >= v9 )
  ...
  v10 = (unsigned __int16 *)TESOutput_PrintLabeledPointer("m_spColorData", *((_DWORD *)this + 7));
  v11 = v2->end;
  v12 = v2->capacity;
  a2 = v10;
  if ( v11 >= v12 )
