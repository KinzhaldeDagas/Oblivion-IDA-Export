void sub_81D090()
{
  ...
  v7 = dword_B452B4;
  if ( VertexShader != (NiD3DVertexShader *)dword_B452B4 )
  {
    if ( VertexShader )
    {
  ...
  v9 = dword_B450A8;
  if ( PixelShader != (NiD3DPixelShader *)dword_B450A8 )
  {
    if ( PixelShader )
    {
  ...
  v3 = v0 == (NiD3DPass *)dword_B459E0;
  dword_B43F5C = 0x20082;
  dword_B445EC = 8;
  if ( !v3 )
  {
    v3 = v0->RefCount-- == 1;
  ...
  if ( v0->StageCount < 4 )
  {
    ...
    sub_801110((int)v1, 0, 1, 2);
    sub_760010(v0, v0->CurrentStage, &v1->Stage);
    v12 = (NiD3DTextureStage **)sub_772630(&v40);
    v3 = v1 == *v12;
    LOBYTE(v41) = 4;
    if ( !v3 )
    {
    ...
    sub_760010(v0, v0->CurrentStage, &v1->Stage);
    v14 = (NiD3DTextureStage **)sub_772630(&v40);
    v3 = v1 == *v14;
    LOBYTE(v41) = 5;
    if ( !v3 )
    {
  ...
  v18 = v0->VertexShader;
  v19 = dword_B452B0;
  if ( v18 != (NiD3DVertexShader *)dword_B452B0 )
  {
    if ( v18 )
    {
  ...
  v20 = v0->PixelShader;
  v21 = dword_B450A4;
  if ( v20 != (NiD3DPixelShader *)dword_B450A4 )
  {
    if ( v20 )
    {
  ...
  if ( !v0->RenderStateGroup )
    v0->RenderStateGroup = (NiD3DRenderStateGroup *)sub_772DF0();
  sub_772CD0((_DWORD *)v0->RenderStateGroup, 0x34, 0, 0);
  v3 = v0 == (NiD3DPass *)dword_B459E4;
  dword_B43F60 = 0x20802;
  dword_B445F0 = 8;
  if ( !v3 )
  {
    v3 = v0->RefCount-- == 1;
  ...
  v24 = v0->VertexShader;
  v25 = dword_B45330;
  if ( v24 != (NiD3DVertexShader *)dword_B45330 )
  {
    if ( v24 )
    {
  ...
  v26 = v0->PixelShader;
  v27 = dword_B450A8;
  if ( v26 != (NiD3DPixelShader *)dword_B450A8 )
  {
    if ( v26 )
    {
  ...
  if ( !v0->RenderStateGroup )
    v0->RenderStateGroup = (NiD3DRenderStateGroup *)sub_772DF0();
  sub_772CD0((_DWORD *)v0->RenderStateGroup, 0x34, 0, 0);
  v3 = v0 == (NiD3DPass *)dword_B459E8;
  dword_B43F64 = 0x60088;
  dword_B445F4 = 8;
  if ( !v3 )
  {
    v3 = v0->RefCount-- == 1;
  ...
  v36 = v0->VertexShader;
  v37 = dword_B4532C;
  if ( v36 != (NiD3DVertexShader *)dword_B4532C )
  {
    if ( v36 )
    {
  ...
  v38 = v0->PixelShader;
  v39 = dword_B450A4;
  if ( v38 != (NiD3DPixelShader *)dword_B450A4 )
  {
    if ( v38 )
    {
