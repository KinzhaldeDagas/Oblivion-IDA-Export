void __thiscall sub_874F30(NiTArray_NiD3DPass *this, int a2, int a3, int a4, NiRenderedTexture *a5)
{
  NiD3DPass *v6; // edi
  int v7; // ebx
  UInt32 Stage; // ebx
  ...
  v16 = v6->Stages.data[1].Texture;
  v17 = (NiRenderedTexture *)dword_B43110;
  v18 = v16->members.super.super.m_uiRefCount;
  p_members = (NiRenderedTexture **)&v16->members;
