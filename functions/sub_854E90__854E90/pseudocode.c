NiTPointerList_Node_void *__thiscall sub_854E90(_DWORD *this, int a2, _WORD *a3, int a4, char *a5, char a6)
{
  int v7; // eax
  char *v8; // esi
  int v9; // eax
