void __thiscall sub_695DC0(MobileObject *this)
{
  ...
  if ( this->process && !this->process->GetProcessLevel(this->process) )
  {
    ...
    vtbl = this->vtbl;
    v48 = 1.0;
    GetNiNode = vtbl->super.GetNiNode;
    v52 = 0;
    v7 = (int)GetNiNode((TESObjectREFR *)this);
    v8 = this->vtbl;
    v45 = v7;
    v9 = v8->super.GetPos((TESObjectREFR *)this);
    v10 = hkFactor;
    v11 = *v9 * v10;
    v41[0] = 0x14;
...
LABEL_24:
        ...
        *((_DWORD *)v27 + 0x7D) |= 0x80000u;
        ...
        this->process->Unk_63(this->process, (void *)v41[0]);
...
LABEL_28:
        ...
        *((float *)CharProxy + 0xC6) = v28;
        ...
        v32 = this->vtbl->super.GetNiNode(this);
        ...
        v37 = this->vtbl->super.GetPos(this);
        v38 = *(_DWORD *)v37;
        v39 = *((_DWORD *)v37 + 1);
        v40 = v42;
...
LABEL_19:
    ...
    {
      v22 = this->vtbl->super.GetNiNode(this);
