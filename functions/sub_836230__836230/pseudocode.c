void sub_836230()
{
  ...
  v9 = dword_B45404;
  if ( VertexShader != (NiD3DVertexShader *)dword_B45404 )
  {
    if ( VertexShader )
    {
  ...
  v11 = dword_B451FC;
  if ( PixelShader != (NiD3DPixelShader *)dword_B451FC )
  {
    if ( PixelShader )
    {
  ...
  v16 = v0->VertexShader;
  v17 = dword_B45408;
  if ( v16 != (NiD3DVertexShader *)dword_B45408 )
  {
    if ( v16 )
    {
  ...
  v18 = v0->PixelShader;
  v19 = dword_B45200;
  if ( v18 != (NiD3DPixelShader *)dword_B45200 )
  {
    if ( v18 )
    {
