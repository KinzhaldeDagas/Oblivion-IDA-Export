unsigned int __thiscall sub_8A2430(__m128 **this, unsigned __int16 *a2)
{
  ...
  sub_8A2A50(this, a2);
  v4 = (unsigned __int16 *)TESOutput_PrintString(*(char **)dword_BA7D68);
  end = v2->end;
