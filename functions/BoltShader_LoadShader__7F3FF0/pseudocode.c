NiD3DShaderProgram *__thiscall BoltShader::LoadShader(BoltShader *this)
{
  ...
  FullPath = "bolt\\v\\bolt.v.hlsl";
  memset(v11, 0, sizeof(v11));
  sub_801030("bolt\\v\\bolt.v.hlsl", (int)FileName);
  _sprintf(v12, "BOLT.vso");
  VertexShader = CreateVertexShader(FileName, v11, "vs_1_1", v12, 0, 0);
  v3 = this->Vertex[0];
  ...
  sub_801030("bolt\\p\\bolt.p.hlsl", (int)FileName);
  _sprintf(v12, "BOLT.pso");
