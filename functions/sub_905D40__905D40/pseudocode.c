int __thiscall sub_905D40(_DWORD *this, int a2, int *a3, __m128 *a4, int a5, int a6)
{
  __m128 v6; // xmm0
  __m128 v7; // xmm1
  __int32 v8; // edi
  ...
  v14 = v8;
  if ( !a6 )
    return sub_905250(this, a3, a2, (int)v22, (int)v12, 0);
  v17[0] = &off_A9B4E8;
  v18 = a4[1].m128_u64[0];
  v9 = a4[1].m128_i32[2];
  v10 = a4[1].m128_i32[3];
  ...
  v19 = v9;
  v20 = v10;
  return sub_905250(this, a3, a2, (int)v22, (int)v12, (int)v17);
}
