unsigned int __thiscall sub_72AD80(unsigned __int16 *this, unsigned __int16 *a2)
{
  ...
  sub_720300(this, a2);
  v4 = (unsigned __int16 *)TESOutput_PrintString(*(char **)dword_B3FF0C);
  end = v2->end;
  ...
  v7 = (unsigned __int16 *)TESOutput_PrintLabeledUnsignedShort("m_usActiveVertices", *(this + 0x2C));
  v8 = v2->end;
  v9 = v2->capacity;
  a2 = v7;
  if ( v8 >= v9 )
  ...
  v10 = (unsigned __int16 *)TESOutput_PrintLabeledUnsignedShort("m_usActiveTriangles", *(this + 0x2D));
  v11 = v2->end;
  a2 = v10;
  if ( v11 >= v2->capacity )
