int __userpurge Player_Actor_ModAVfOffset@<eax>(
        ...
        Actor *a5)
{
  ...
  if ( g_GodMode && a4 < 0.0 && a2 >= 8 && a2 <= 0xA )
    return Player_Actor_ModAVfOffset_::nullsub_31(a2, LODWORD(a4), a5);
  sub_5E02D0(a2, a4, (int)a5);
  v10 = st7_0;
  if ( a2 != 0xFFFFFFFF )
    a1->scriptAVModifiers[a2] = Player_ModAVNode(a1->scriptAVModifiers[a2], v10, 1);
  sub_57A6F0(a2);
  if ( a2 != 8 || v10 >= 0.0 )
