unsigned int __thiscall sub_727E90(unsigned __int16 *this, unsigned __int16 *a2)
{
  ...
  sub_7278B0(this, a2);
  v4 = (unsigned __int16 *)TESOutput_PrintString(*(char **)dword_B3FD98);
  end = v2->end;
  ...
  v7 = (unsigned __int16 *)TESOutput_PrintLabeledUnsignedInt("m_uiShaderDeclarationIndex", *((_DWORD *)this + 0xB));
  v8 = v2->end;
  v9 = v2->capacity;
  a2 = v7;
  if ( v8 >= v9 )
