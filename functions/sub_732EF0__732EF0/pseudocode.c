unsigned int __thiscall sub_732EF0(NiTriBasedGeomData *this, unsigned __int16 *a2)
{
  ...
  sub_729D00(this, a2);
  v4 = (unsigned __int16 *)TESOutput_PrintString(*(char **)dword_B40108);
  end = v2->end;
  ...
  v7 = (unsigned __int16 *)TESOutput_PrintLabeledUnsignedShort("m_usTriangles", this->members.m_usTriangles);
  v8 = v2->end;
  v9 = v2->capacity;
  a2 = v7;
  if ( v8 >= v9 )
