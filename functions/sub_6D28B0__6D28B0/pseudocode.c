unsigned int __userpurge sub_6D28B0@<eax>(float *this@<ecx>, unsigned int a2@<ebp>, unsigned __int16 *a3)
{
  ...
  v5 = (unsigned __int16 *)TESOutput_PrintString(*(_DWORD *)dword_B3CF5C);
  end = v3->end;
  ...
  v8 = (unsigned __int16 *)TESOutput_PrintLabeledFloat((int)"m_fFloatValue", *(this + 0xC));
  v9 = v3->end;
  v10 = v3->capacity;
  a3 = v8;
  if ( v9 >= v10 )
