unsigned int __userpurge sub_741540@<eax>(_DWORD *this@<ecx>, int a2@<ebp>, unsigned __int16 *a3)
{
  ...
  v5 = (unsigned __int16 *)TESOutput_PrintString(*(char **)dword_B40200);
  end = v3->end;
  ...
  v8 = (unsigned __int16 *)TESOutput_PrintLabeledBool("m_bDither", (char)a3);
  v9 = v3->end;
  a3 = v8;
  if ( v9 >= v3->capacity )
