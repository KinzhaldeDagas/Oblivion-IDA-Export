unsigned int __thiscall sub_6FBAC0(float *this, unsigned __int16 *a2)
{
  ...
  sub_721730(this, a2);
  v4 = (unsigned __int16 *)TESOutput_PrintString(*(_DWORD *)dword_B3F4BC);
  end = v2->end;
  ...
  v7 = (unsigned __int16 *)sub_707280(this + 3, (int)"Center");
  v8 = v2->end;
  v9 = v2->capacity;
  a2 = v7;
  if ( v8 >= v9 )
  ...
  v10 = (unsigned __int16 *)sub_707280(this + 6, (int)"Extents");
  v11 = v2->end;
  v12 = v2->capacity;
  a2 = v10;
  if ( v11 >= v12 )
