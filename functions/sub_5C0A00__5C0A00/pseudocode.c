void __userpurge sub_5C0A00(int a1@<ecx>, double st7_0@<st0>, int a3, int a4)
{
  ...
  if ( a3 == 4 )
  {
    ...
    sub_588C50((_DWORD *)*(_DWORD *)(a1 + 0x30));
    Float = Tile_GetFloat((_DWORD *)*(_DWORD *)(a1 + 0x34), 0xFB6);
    Tile_SetFloat(*(Tile **)(a1 + 0x34), (_DWORD *)0xFB7, flt_A6B1F0);
