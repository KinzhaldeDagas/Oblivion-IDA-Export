...
LABEL_28:
  ...
  v19 = (ShadowLightShader *)FormHeapAlloc(0x9Cu);
  if ( v19 )
    v20 = (volatile LONG *)ShadowLightShader::ShadowLightShader(v19, v24, v12, v15, v18);
  else
    v20 = 0;
  ...
  (*(void (__thiscall **)(volatile LONG *))(*v20 + 0xB8))(v20);
