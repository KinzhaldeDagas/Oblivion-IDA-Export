void __thiscall __noreturn sub_796FE0(_DWORD *this, int a2, char *a3, unsigned int a4, int a5)
{
  int v6; // ecx
  int v7; // eax
  unsigned int v8; // ebx
  ...
  v21 = &v16;
  v20 = this;
  sub_795480(&v17, (unsigned int)&savedregs, (unsigned int)this, a5);
  v6 = *(this + 1);
  v7 = 0;
  v22 = 0;
  if ( v6 )
  ...
  if ( a4 )
  {
    ...
    if ( v8 < a4 + v9 )
    {
      ...
      LOBYTE(v19) = 0;
      LOBYTE(v22) = 1;
      sub_795E00(v14, a3, v13);
    }
    v15 = (char *)*(this + 2);
    v19 = v15;
    if ( (v15 - a3) >> 4 < a4 )
      sub_796910(a3, v15, &a3[0x10 * a4]);
    sub_796910(&v15[0xFFFFFFF0 * a4], v15, v15);
  }
  if ( v18 )
    FormHeapFree(v18);
}
