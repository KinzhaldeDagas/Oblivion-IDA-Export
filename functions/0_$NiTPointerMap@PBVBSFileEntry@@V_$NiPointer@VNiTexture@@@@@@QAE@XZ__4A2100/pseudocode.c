NiTPointerMap<BSFileEntry const *,NiPointer<NiTexture>> *__thiscall NiTPointerMap<BSFileEntry const *,NiPointer<NiTexture>>::NiTPointerMap<BSFileEntry const *,NiPointer<NiTexture>>(
        NiTPointerMap<BSFileEntry const *,NiPointer<NiTexture>> *this,
        unsigned int a2)
{
  int v3; // eax
