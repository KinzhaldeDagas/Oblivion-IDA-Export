unsigned int __thiscall sub_758E90(float *this, unsigned __int16 *a2)
{
  ...
  sub_752EC0(this, a2);
  v4 = (unsigned __int16 *)TESOutput_PrintString(*(char **)dword_B417C4);
  end = v2->end;
  ...
  if ( v7 )
    ...
    v8 = "None";
  v9 = (unsigned __int16 *)TESOutput_PrintLabeledString("Drag Object", v8);
  v10 = v2->end;
  v11 = v2->capacity;
  a2 = v9;
  if ( v10 >= v11 )
  ...
  v12 = (unsigned __int16 *)sub_707280(this + 7, "Drag Axis");
  v13 = v2->end;
  v14 = v2->capacity;
  a2 = v12;
  if ( v13 >= v14 )
  ...
  v15 = (unsigned __int16 *)TESOutput_PrintLabeledFloat("Percentage", *(this + 0xA));
  v16 = v2->end;
  v17 = v2->capacity;
  a2 = v15;
  if ( v16 >= v17 )
  ...
  v18 = (unsigned __int16 *)TESOutput_PrintLabeledFloat("Range", *(this + 0xB));
  v19 = v2->end;
  v20 = v2->capacity;
  a2 = v18;
  if ( v19 >= v20 )
  ...
  v21 = (unsigned __int16 *)TESOutput_PrintLabeledFloat("RangeFalloff", *(this + 0xC));
  v22 = v2->end;
  v23 = v2->capacity;
  a2 = v21;
  if ( v22 >= v23 )
