        ...
        const void **a8)
{
  ...
  for ( i = (_WORD *)(v8 + 4 * v10); a5 < v11; LOWORD(v10) = v10 - 1 )
  {
    ...
    *i = v11;
    ...
    if ( (v11 & 1) != 0 )
    {
      v15 = *(_WORD *)(v14 + 0xA) - a3[4];
      v16 = (a3[3] - *(_WORD *)(v14 + 2)) | (a3[5] - *(_WORD *)(v14 + 8));
      v17 = *(_WORD *)(v14 + 6) - a3[1];
      *(_WORD *)(v14 + 4) = v10;
