unsigned int __stdcall sub_9A3730(int a1, int a2, int a3)
{
  ...
  if ( dword_B428D8[(unsigned __int8)v4] == 1 )
  {
    ...
    v5 = (*(int (__thiscall **)(int, int, int *, _DWORD))(*(_DWORD *)a1 + 0x30))(a1, a2, &dword_BAA930, 0);
    goto LABEL_27;
  }
  v6 = *(_DWORD *)(a2 + 0x14);
  if ( !byte_B4295B )
  ...
  if ( dword_B428D8[(unsigned __int8)v6] == 3 )
  {
    ...
    v5 = (*(int (__thiscall **)(int, int, int *, _DWORD))(*(_DWORD *)a1 + 0x30))(a1, a2, &dword_BAA934, 0);
    goto LABEL_27;
  }
  v7 = *(_DWORD *)(a2 + 0x14);
  if ( !byte_B4295B )
...
LABEL_26:
    flt_BAA99C = v8;
    v5 = (*(int (__thiscall **)(int, int, float *, _DWORD))(*(_DWORD *)a1 + 0x30))(a1, a2, &flt_BAA990, 0);
    goto LABEL_27;
  }
  v9 = *(_DWORD *)(a2 + 0x14);
  if ( !byte_B4295B )
  ...
  if ( sub_782DE0((_DWORD *)a2) )
  {
    ...
    flt_BAA9C8 = v12[8];
    flt_BAA9CC = 0.0;
    v5 = (*(int (__thiscall **)(int, int, float *, _DWORD))(*(_DWORD *)a1 + 0x30))(a1, a2, &flt_BAA9A0, 0);
  }
  else
  {
    if ( !sub_782E10((_DWORD *)a2) )
      return v3;
    v5 = (*(int (__thiscall **)(int, int, _DWORD, _DWORD))(*(_DWORD *)a1 + 0x30))(a1, a2, *(_DWORD *)(a2 + 0x30), 0);
  }
LABEL_27:
  if ( !v5 )
    return 0x80000050;
