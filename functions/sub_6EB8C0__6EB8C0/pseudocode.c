unsigned int __userpurge sub_6EB8C0@<eax>(float *this@<ecx>, unsigned int a2@<ebp>, unsigned __int16 *a3)
{
  ...
  v5 = (unsigned __int16 *)TESOutput_PrintString(*(_DWORD *)dword_B3EA50);
  end = v3->end;
  ...
  v8 = (unsigned __int16 *)sub_70FA00((int)"m_bBoolValue", *((_BYTE *)this + 0x30));
  v9 = v3->end;
  v10 = v3->capacity;
  a3 = v8;
  if ( v9 >= v10 )
