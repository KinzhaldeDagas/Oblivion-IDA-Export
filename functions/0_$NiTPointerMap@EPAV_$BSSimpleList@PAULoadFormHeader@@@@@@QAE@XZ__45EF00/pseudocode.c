        ...
        unsigned int a2)
{
  ...
  *((_DWORD *)this + 1) = a2;
  *(_DWORD *)this = &NiTMapBase<NiTPointerAllocator<unsigned int>,unsigned char,BSSimpleList<LoadFormHeader *> *>::`vftable';
  *((_DWORD *)this + 3) = 0;
  v3 = FormHeapAlloc((unsigned __int64)a2 >> 0x1E != 0 ? 0xFFFFFFFF : 4 * a2);
  v5 = 4 * *((_DWORD *)this + 1);
  *((_DWORD *)this + 2) = v3;
  _memset(v3, 0, v5);
  *(_DWORD *)this = &NiTPointerMap<unsigned char,BSSimpleList<LoadFormHeader *> *>::`vftable';
  return this;
}
