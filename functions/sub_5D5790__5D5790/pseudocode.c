        ...
        int a7)
{
  ...
  if ( a6 == 3 )
  {
    ...
    Tile_GetFloat(*(_DWORD **)(a1 + 0x2C), 0xFB0);
    __asm { fstp    [esp+1Ch+var_10] }
    Tile_GetFloat(*(_DWORD **)(a1 + 0x2C), 0xFAF);
    ...
    Float = Tile_GetFloat((_DWORD *)*(_DWORD *)(a1 + 0x2C), 0xFCA);
    ...
    Tile_SetFloat(*(Tile **)(a1 + 0x2C), (_DWORD *)0xFB3, a2a);
    __asm
    {
    ...
    __asm { fstp    [esp+1Ch+a2]; a3 }
    Tile_SetFloat(*(Tile **)(a1 + 0x2C), (_DWORD *)0xFB3, a2b);
    __asm { fldz }
    __asm { fstp    [esp+1Ch+a2]; a3 }
    Tile_SetFloat(*(Tile **)(a1 + 0x2C), (_DWORD *)0xFB3, a2c);
  }
}
