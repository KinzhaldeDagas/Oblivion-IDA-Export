unsigned int __userpurge sub_6EAD90@<eax>(float *this@<ecx>, unsigned int a2@<ebp>, unsigned __int16 *a3)
{
  ...
  v5 = (unsigned __int16 *)TESOutput_PrintString(*(_DWORD *)dword_B3E980);
  end = v3->end;
  ...
  v8 = (unsigned __int16 *)sub_707280(this + 0xC, (int)"m_kPoint3Value");
  v9 = v3->end;
  v10 = v3->capacity;
  a3 = v8;
  if ( v9 >= v10 )
