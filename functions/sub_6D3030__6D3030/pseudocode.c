unsigned int __thiscall sub_6D3030(void *this, unsigned __int16 *a2)
{
  ...
  sub_6EC460(this, a2);
  v4 = (unsigned __int16 *)TESOutput_PrintString(*(_DWORD *)dword_B3CFBC);
  end = v2->end;
  ...
  v7 = (unsigned __int16 *)TESOutput_PrintLabeledFloat((int)"m_fFloatValue", *((float *)this + 3));
  v8 = v2->end;
  v9 = v2->capacity;
  a2 = v7;
  if ( v8 >= v9 )
  ...
  v10 = (unsigned __int16 *)TESOutput_PrintLabeledPointer("m_spFloatData", *((_DWORD *)this + 4));
  v11 = v2->end;
  v12 = v2->capacity;
  a2 = v10;
  if ( v11 >= v12 )
