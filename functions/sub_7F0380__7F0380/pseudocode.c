NiD3DShaderProgram *__thiscall sub_7F0380(char *this)
{
  int v1; // esi
  char **v2; // edi
  char *v3; // ebx
  ...
  v26[0] = "speedtree\\leaf.v.hlsl";
  memset(&v26[1], 0, 0x48);
  v26[0x13] = "speedtree\\leaf.v.hlsl";
  v26[0x14] = &off_A90D88;
  v26[0x15] = EmptyString;
  memset(&v26[0x16], 0, 0x40);
  v26[0x26] = "speedtree\\leaf.v.hlsl";
  v26[0x27] = "PT";
  v26[0x28] = EmptyString;
  memset(&v26[0x29], 0, 0x40);
  v26[0x39] = "speedtree\\leaf.v.hlsl";
  v26[0x3A] = "PT";
  v26[0x3B] = EmptyString;
  v26[0x3C] = &off_A90D88;
  v26[0x3D] = EmptyString;
  memset(&v26[0x3E], 0, 0x38);
  v25[0] = "speedtree\\leaf.p.hlsl";
  memset(&v25[1], 0, 0x48);
  v25[0x13] = "speedtree\\leaf.p.hlsl";
  v25[0x14] = &off_A90D88;
  ...
  do
  {
    if ( *v2 )
    {
      ...
      _sprintf(v28, "STLEAF%03i.vso", v1);
  ...
  while ( v8 );
  v9 = 0;
  v10 = (NiD3DShaderProgram **)(this + 0x38C);
  ...
  if ( ShaderPackage < 2 )
  {
    ...
    do
    {
      ...
      if ( *v11 )
      {
        ...
        _sprintf(v28, "STLEAF%03i.pso", v9);
  ...
  else
  {
    ...
    do
    {
      ...
      {
        sub_801030((char *)result, (int)FileName);
        _sprintf(v28, "STLEAF2%03i.pso", v9);
