ShaderDefinition *__cdecl RefractionShader()
{
  ...
  v6 = (RefractionShader *)FormHeapAlloc(0xC4u);
  if ( v6 )
    v7 = RefractionShader::RefractionShader(v6);
  else
    v7 = 0;
  v7->super.__vftable->super.Unk084((BSShader *)v7);
  ((void (__thiscall *)(RefractionShader *))v7->super.__vftable[1].super.super.super.super.super.Destructor)(v7);
  v7->super.__vftable[1].super.super.super.super.GetType((NiShader *)v7);
  shader = (RefractionShader *)v1->shader;
  if ( shader != v7 )
  {
    if ( shader )
    {
