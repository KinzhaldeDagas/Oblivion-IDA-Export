void __userpurge sub_5D2D80(int a1@<ecx>, double st5_0@<st2>, double st6_0@<st1>, double a4@<st0>, int a5, int a6)
{
  ...
  if ( a5 == 4 )
  {
    ...
    Tile_GetFloat(*(_DWORD **)(a1 + 0x34), 0xFB0);
    __asm { fstp    [esp+18h+var_8] }
    Tile_GetFloat(*(_DWORD **)(a1 + 0x34), 0xFAF);
    ...
    Tile_GetFloat(*(_DWORD **)(a1 + 0x34), 0xFCA);
    __asm
    {
    ...
    if ( __SETP__(HIBYTE(_AX) & 5, 0) )
    {
      ...
      __asm { fsubr   [esp+18h+a3] }
      __asm { fstp    qword ptr [esp+1Ch+a3] }
      Float = Tile_GetFloat((_DWORD *)*(_DWORD *)(a1 + 0x34), 0xFCA);
      __asm
      {
        fdivr   qword ptr [esp+18h+a3]
        fld1
...
LABEL_7:
        ...
        Tile_SetFloat(*(Tile **)(a1 + 0x34), (_DWORD *)0xFB3, a2);
        __asm
        {
          fld     [esp+18h+var_8]
          fld     [esp+18h+var_4]
        ...
        __asm { fstp    [esp+1Ch+a2]; a3 }
        Tile_SetFloat(*(Tile **)(a1 + 0x34), (_DWORD *)0xFB3, a2a);
        __asm { fldz }
        __asm { fstp    [esp+1Ch+a2]; a3 }
        Tile_SetFloat(*(Tile **)(a1 + 0x34), (_DWORD *)0xFB3, a2b);
        return;
      }
      __asm { fstp    st }
    }
