TESFormVtbl *__thiscall sub_6A9AA0(_DWORD *this)
{
  int v2; // edx
  unsigned int v3; // ecx
  unsigned int v4; // eax
...
LABEL_5:
  ...
  if ( result )
  {
    do
    {
      ...
      {
        v9 = (unsigned int)result & 0xFFFFFDFF;
        v10->vtbl = (TESFormVtbl *)v9;
        if ( (v9 & 1) != 0 )
          result = (TESFormVtbl *)sub_6B7130((int)v8, 0);
        else
          result = (TESFormVtbl *)sub_6B6E60(v8, 1);
      }
    }
    while ( v11 );
  }
