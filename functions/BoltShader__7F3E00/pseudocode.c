...
LABEL_13:
  ...
  v8 = (BoltShader *)FormHeapAlloc(0x1A4u);
  if ( v8 )
    v9 = (BSShader *)BoltShader::BoltShader(v8, v5);
  else
    v9 = 0;
  v9->__vftable->Unk084(v9);
  ((void (__thiscall *)(BSShader *))v9->__vftable[1].super.super.super.super.Destructor)(v9);
  v9->__vftable[1].super.super.super.GetType((NiShader *)v9);
  v9->__vftable->Unk088(v9);
  shader = v1->shader;
  if ( shader != v9 )
  {
    if ( shader )
    ...
    v1->shader = v9;
    InterlockedIncrement((volatile LONG *)&v9->member);
  }
