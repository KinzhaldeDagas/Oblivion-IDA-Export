char __thiscall sub_5517F0(char *this, unsigned int **a2)
{
  ...
  v12 = 0;
  v13 = 0;
  if ( !a2 || !sub_5512A0(a2) || !strlen((const char *)sub_5512A0(a2)) )
    return 0;
  v3 = 0;
  ...
  v5 = sub_5512A0(a2);
  if ( sub_4A1AB0((_DWORD *)this + 1, v5, &v12) || (v6 = sub_551250(a2), sub_4A1AB0((_DWORD *)this + 1, v6, &v12)) )
  {
