        ...
        UInt32 *a3)
{
  ...
  signed int v20; // [esp+0h] [ebp-8h] BYREF
  char ArgList[4]; // [esp+4h] [ebp-4h] BYREF

  *(_DWORD *)ArgList = 0;
  v20 = 0;
  result = Script_ExtractArgs(a1, a9, a3, a4, a11, a12, l, ArgList, &v20);
  if ( result )
  {
    CurrentWorldspace = TES::GetCurrentWorldspace(TES);
    if ( CurrentWorldspace || (CurrentWorldspace = *(TESWorldSpace **)(TESDataHandler + 0xC)) != 0 )
    {
      if ( dword_B35B90 )
        sub_4BE5A0((_DWORD *)dword_B35B90);
      if ( dword_B35B8C )
        sub_4BD980((_DWORD *)dword_B35B8C);
      CellAtCellCoord = (TESForm *)TESWorldSpace::GetCellAtCellCoord(CurrentWorldspace, *(signed int *)ArgList, v20);
      if ( CellAtCellCoord
        || (CellAtCellCoord = sub_4F1630(CurrentWorldspace, a5, a6, a7, *(int *)ArgList, v20)) != 0
        || (CellAtCellCoord = sub_4471D0(0, *(int *)ArgList, v20, (int **)CurrentWorldspace)) != 0 )
      {
