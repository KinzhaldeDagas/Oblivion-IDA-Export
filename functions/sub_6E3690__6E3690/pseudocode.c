int __thiscall sub_6E3690(NiRenderer *this, signed int a2)
{
  ...
  if ( a2 )
  {
    ...
    v7 = v13;
    v9 = a2;
    LOBYTE(this->members.pad014[0]) = byte_B3D3E8[v13];
    v8 = (*(int (__cdecl **)(signed int, signed int))(4 * v7 + 0xB3D088))(v2, v9);
    (*(void (__cdecl **)(int, signed int, _DWORD))(4 * v7 + 0xB3D410))(v8, a2, LOBYTE(this->members.pad014[0]));
    return sub_6E3540(this, v8, a2, v7);
  }
  return result;
}
