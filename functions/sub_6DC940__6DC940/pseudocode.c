float *__thiscall sub_6DC940(_DWORD *this, unsigned int a2, unsigned int a3, float a4, float *a5)
{
  float *result; // eax
  int v7; // ebp
  ...
  if ( result )
  {
    ...
    if ( LODWORD(v32) >= 2 )
    {
      if ( (*(_BYTE *)(this + 0xF) & 4) != 0 )
      {
        ...
        if ( 0.0 != *((float *)this + 0x17) )
        {
          v11 = a4;
          if ( 1.0 - *((float *)this + 0x17) > a4 )
          {
            if ( *((float *)this + 0x17) >= v11 )
            {
              if ( (*(_BYTE *)(this + 0xF) & 2) != 0 || a2 )
                v36 = a2;
              else
                v36 = LODWORD(v32) - 1;
              if ( v36 )
              {
                v37 = (*((float *)this + 0x17) - v11) / (*((float *)this + 0x17) + *((float *)this + 0x17));
                v32 = 1.0 - v37;
                sub_6BBEE0(
                  *((float *)this + 0x17),
                  v33,
          ...
          {
            if ( (*(_BYTE *)(this + 0xF) & 2) != 0 || a3 != LODWORD(v32) - 1 )
              v36 = a3;
            else
              v36 = 0;
            ...
            {
              v23 = v33;
              v32 = (1.0 - v11 + *((float *)this + 0x17)) / (*((float *)this + 0x17) + *((float *)this + 0x17));
              v37 = 1.0 - v32;
              *(float *)&v33 = 1.0 - *((float *)this + 0x17);
      ...
      result = (float *)(*((__int16 *)this + 0x30) - 1);
      if ( *((_WORD *)this + 0x30) == 1 )
      {
        v29 = SLODWORD(v44[0]);
        v30 = v44[3];
        v31 = v44[6];
      ...
      {
        result = (float *)(*((__int16 *)this + 0x30) - 2);
        if ( *((_WORD *)this + 0x30) == 2 )
        {
          v29 = SLODWORD(v44[0]);
          v30 = v44[3];
          v31 = v44[6];
      ...
      if ( (v21 & 8) != 0 )
      {
        if ( (dword_B3DD9C & 1) == 0 )
        {
          v22 = flt_B3F9A4;
          dword_B3DD9C |= 1u;
          flt_B3DD98 = dbl_A3C800 / v22;
        }
        *(float *)&v35 = (double)(int)*(this + 0x1A) * *((float *)this + 0x16);
        if ( *((float *)this + 0x19) > (double)*(float *)&v34 )
        {
          *(float *)&v33 = *(float *)&v34 / *((float *)this + 0x19);
          *(float *)&v33 = atan(*(float *)&v33);
          *(float *)&v35 = *(float *)&v33 * flt_B3DD98 * *(float *)&v35;
          v18 = *(float *)&v45;
          v20 = v47;
          v19 = v46;
        }
