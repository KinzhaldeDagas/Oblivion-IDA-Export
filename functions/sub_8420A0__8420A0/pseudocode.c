void __thiscall sub_8420A0(NiTArray_NiD3DPass *this, int a2, int a3, NiRenderedTexture *Stage, _DWORD *a5)
{
  ...
  sub_848FA0(Stage, (int)v9);
  v17 = *(_DWORD *)(*(_DWORD *)(v7 + 0x24) + 0x14);
  ...
  v22 = *(_DWORD *)(*(_DWORD *)(v7 + 0x24) + 0x18);
