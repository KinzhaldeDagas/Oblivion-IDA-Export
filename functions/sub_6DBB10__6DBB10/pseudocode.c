  ...
  if ( *(float *)(this + 0x24) < 0.0 )
  {
    ...
    *v5 = 0.0;
    if ( v4 != 1 )
    {
      do
      {
        v8 = sub_6DB6F0((_DWORD *)this, v3, v3 + 1, 1.0);
        *(float *)(*(_DWORD *)(this + 0x20) + 4 * v3 + 4) = *(float *)(*(_DWORD *)(this + 0x20) + 4 * v3) + v8;
        ++v3;
      }
      while ( v3 < v4 - 1 );
      v4 = v7;
    }
    *(float *)(this + 0x24) = *(float *)(*(_DWORD *)(this + 0x20) + 4 * v4 - 4);
  }
