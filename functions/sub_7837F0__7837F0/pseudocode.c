bool __thiscall sub_7837F0(int this, _DWORD *a2, int a3, int a4)
{
  ...
  if ( *(_DWORD *)(this + 0x40) && *(_DWORD *)(this + 0x1C) )
  {
    if ( !a3 )
      a3 = a2[0xC];
    v5 = a2[9];
    if ( !v5 )
      v5 = a2[3];
    v6 = (*(int (__stdcall **)(_DWORD, _DWORD, int))(**(_DWORD **)(this + 0x40) + 0x24))(
           *(_DWORD *)(this + 0x40),
           0,
           v5);
    if ( v6 )
    {
      ...
      if ( *(_DWORD *)(4 * (unsigned __int8)v9 + 0xB428D8) == 8 || sub_782E10(a2) )
      {
        ...
        if ( (*(int (__stdcall **)(_DWORD, int, _BYTE *, int))(**(_DWORD **)(*(_DWORD *)(this + 0x24) + 0xFF8) + 0x178))(
...
LABEL_26:
      ...
      {
        if ( sub_783010(*(_DWORD ***)(this + 0x24), v14, a3, v15, 0) )
          goto LABEL_26;
        return v11 >= 0;
      }
      if ( sub_7832E0(a2) )
      {
        if ( sub_783040(*(_DWORD ***)(this + 0x24), v14, a3, v15, 0) )
          goto LABEL_26;
        return v11 >= 0;
      }
      if ( sub_7832B0(a2) )
      {
        if ( sub_782FE0(*(_DWORD ***)(this + 0x24), v14, a3, v15, 0) )
          goto LABEL_26;
        return v11 >= 0;
      }
    }
