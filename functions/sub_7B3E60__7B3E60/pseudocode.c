unsigned int *sub_7B3E60()
{
  ...
  if ( dword_B2C350 )
  {
    ...
    {
      if ( ++v0 >= (unsigned int)dword_B2C350 )
        goto LABEL_5;
    }
...
LABEL_5:
  ...
  if ( !v4 )
  {
    if ( result )
    {
      do
      {
        sub_7B2600((unsigned int **)&off_B2C34C, &v12, &v13, &v11);
        v3 = v11;
        if ( v11 )
        {
          v6 = *(_DWORD *)(v11 + 8);
    ...
    result = (unsigned int *)NiTMap_Clear(&off_B2C34C);
  }
  v14 = 0xFFFFFFFF;
  if ( v3 )
  {
    ...
    if ( !result )
      return (unsigned int *)(**(int (__thiscall ***)(unsigned int, int))v3)(v3, 1);
  }
  return result;
}
