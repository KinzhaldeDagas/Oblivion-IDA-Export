bhkSpringAction *__thiscall bhkSpringAction::bhkSpringAction(bhkSpringAction *this, int a2)
{
  ...
  if ( v4 )
  {
    ...
    ++dword_BA7D40;
    v5->__vftable = (NiObjectVtbl *)&bhkSpringAction::`vftable';
    ++dword_BA8058;
  }
  else
  {
  ...
  (*(void (__thiscall **)(bhkSpringAction *, bhkRefObject *, int))(*(_DWORD *)this + 0x88))(this, v5, a2);
  if ( dword_BA7CFC-- == 1 )
    dword_BA7CF8 = 0;
  LeaveCriticalSection(&stru_BA7C80);
  return (bhkSpringAction *)v5;
}
