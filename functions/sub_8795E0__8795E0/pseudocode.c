void __thiscall sub_8795E0(NiTArray_NiD3DPass *this, int a2, int a3, int a4, NiRenderedTexture *a5)
{
  int v6; // edi
  int v7; // ebp
  int v8; // ebx
  ...
  v16 = *(_DWORD *)(*(_DWORD *)(v6 + 0x24) + 0x14);
  ...
  v21 = *(_DWORD *)(*(_DWORD *)(v6 + 0x24) + 0x18);
  ...
  v25 = *(_DWORD *)(*(_DWORD *)(v6 + 0x24) + 0x1C);
