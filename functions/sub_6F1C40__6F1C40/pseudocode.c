_DWORD *__thiscall sub_6F1C40(_DWORD *this, int a2, _DWORD *Src, unsigned int a4, _DWORD *a5)
{
  _DWORD *result; // eax
  int v7; // ecx
  unsigned int v8; // edi
  ...
  if ( a4 )
  {
    ...
    if ( v8 >= a4 + v11 )
    {
      ...
      if ( v23 )
      {
        ...
        *(this + 2) += v27;
        return sub_790490(Src, (_DWORD *)(*(this + 2) - v27), &a5);
      }
      else
      {
        v24 = (int)&v21[-v22];
        *(this + 2) = sub_7A25C0(&v21[-v22], (int)v21, v21);
        ...
        return sub_790490(Src, &Src[v27 / 4u], &a5);
      }
    }
    else
    {
