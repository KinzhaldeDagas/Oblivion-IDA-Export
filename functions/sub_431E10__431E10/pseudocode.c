int *__thiscall sub_431E10(int ***this, int a2, _DWORD *a3, int *a4)
{
  ...
  while ( 1 )
  {
    ...
    if ( ((unsigned int)*(this + 5) & 0xFFFFFFFE) == 0 )
      break;
    ((void (__thiscall *)(int **, _DWORD, _DWORD))(**this)[8])(*this, *a3, a3[1]);
    *(_QWORD *)a3 = ((__int64 (__thiscall *)(int **, _DWORD, _DWORD))(**this)[9])(
                      *this,
                      *(_DWORD *)((unsigned int)*(this + 5) & 0xFFFFFFFE),
                      *(_DWORD *)(((unsigned int)*(this + 5) & 0xFFFFFFFE) + 4));
    result = a4;
    v7 = *a4;
    v8 = (int *)(((unsigned int)*(this + 5) & 0xFFFFFFFE) + 8);
    if ( *a4 != *v8 )
    {
      if ( v7 )
      {
    ...
    LOBYTE(result) = 1;
    if ( (*(_DWORD *)(((unsigned int)*(this + 5) & 0xFFFFFFFE) + 0xC) & 1) == 0 )
      goto LABEL_12;
  }
  LOBYTE(result) = 0;
LABEL_12:
