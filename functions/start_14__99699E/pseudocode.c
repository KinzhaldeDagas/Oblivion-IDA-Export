double __usercall start_14@<st0>(__m128i a1@<xmm0>, __m128d a2@<xmm1>)
{
  double v2; // xmm3_8
  __m128d v3; // xmm1
  double v4; // xmm4_8
  ...
  else
  {
    ...
    v5 = (double *)((char *)&unk_AADAC0 + 0x20 * ((int)(10.1859163578813 * *(double *)a1.m128i_i64) & 0x3F));
    v6 = _mm_mul_pd((__m128d)xmmword_AAE310, v3);
    *(double *)a1.m128i_i64 = *(double *)a1.m128i_i64 - v2;
    v7 = _mm_unpacklo_pd((__m128d)a1, (__m128d)a1);
    v8 = v4 - v2;
    v9 = v8 - v6.m128d_f64[0];
    v10 = _mm_mul_pd((__m128d)xmmword_AAE2F0, v7);
    ...
    v19 = _mm_mul_pd((__m128d)xmmword_AAE2D0, v14);
    v20 = _mm_mul_pd(v16, v14);
    v21 = _mm_mul_pd(_mm_add_pd(v13, (__m128d)xmmword_AAE2E0), _mm_mul_pd(v14, v14));
    v14.m128d_f64[0] = v17 * v9;
    v22 = v14.m128d_f64[0] + v5[1];
    v23 = _mm_mul_pd(_mm_add_pd(_mm_add_pd(v19, (__m128d)xmmword_AAE2C0), v21), v20);
    return v9 * *v5
         + v22
         + v3.m128d_f64[0] * v18
         + v5[2]
