        ...
        int a10)
{
  ...
  v12 = (*(int (__thiscall **)(_DWORD *, unsigned int))(*this + 0x3C))(this, v11 & 0xFFF);
  v13 = (*(int (__thiscall **)(_DWORD *, unsigned int))(*this + 0x3C))(this, (v11 >> 0xC) & 0xFFF);
  v14 = v13;
  v25 = v13;
  if ( v12 && v13 )
  {
    ...
    {
      case 0x20000000u:
        v23 = sub_9A4960(*(char **)(v12 + 0xC));
        sub_9A73C0(this, 0, v12, a4, a5, a6, a7, a8, a9);
        break;
      case 0x40000000u:
    ...
    {
      case 0x20000000u:
        v24 = sub_9A4960(*(char **)(v25 + 0xC));
        sub_9A73C0(this, 1, v25, a4, a5, a6, a7, a8, a9);
        break;
      case 0x30000000u:
    ...
    if ( v23 && v24 )
    {
      ...
      {
        if ( v26 == 0x40000000 )
          return sub_9A52E0(a2, a3, v23, v24, v22, v21);
      }
      else
      {
        switch ( v26 )
        {
          case 0x30000000u:
            return sub_9A50B0(a2, a3, v23, v24, v22, v21);
          case 0x10000000u:
            return sub_9A4B00(a2, a3, v23, v24, v22, v21);
          case 0x20000000u:
            return sub_9A4E30(a2, a3, v23, v24, *(float *)&v22, v21);
        }
      }
    }
    else
