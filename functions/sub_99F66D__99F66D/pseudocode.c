signed int __cdecl sub_99F66D(unsigned __int16 *a1, int *a2)
{
  ...
  if ( v3 != 0xFFFFC001 )
  {
    ...
    v8 = dword_B3210C - 1;
    v64 = v3;
    v65 = dword_B3210C / 0x20;
    v9 = &v60 + dword_B3210C / 0x20;
    v66 = 0x1F - dword_B3210C % 0x20;
    if ( ((1 << (0x1F - dword_B3210C % 0x20)) & *v9) != 0 )
    {
      v10 = v65;
      for ( i = (~(0xFFFFFFFF << (0x1F - dword_B3210C % 0x20)) & *(&v60 + v65)) == 0; i; i = *(&v60 + v10) == 0 )
      {
        if ( ++v10 >= 3 )
          goto LABEL_22;
      }
...
LABEL_22:
    *v9 &= 0xFFFFFFFF << v66;
    ...
    if ( v68 )
      ++v3;
    if ( v3 >= dword_B32108 - dword_B3210C )
    {
      if ( v3 > dword_B32108 )
      {
        if ( v3 < dword_B32104 )
        {
          v60 &= ~0x80000000;
          v5 = dword_B32118 + v3;
          v50 = dword_B32110 / 0x20;
          v51 = dword_B32110 % 0x20;
          v65 = 0;
          v74 = 0;
          v67 = 0x20 - dword_B32110 % 0x20;
          do
          {
            v52 = *(&v60 + v74);
        ...
        else
        {
          ...
          v62 = 0;
          v60 = 0x80000000;
          v43 = dword_B32110 / 0x20;
          v44 = dword_B32110 % 0x20;
          v65 = 0;
          v73 = 0;
          v67 = 0x20 - dword_B32110 % 0x20;
          do
      ...
      v60 = v57;
      v61 = v58;
      v17 = (int)(dword_B32108 - v64) / 0x20;
      v62 = v59;
      v18 = (int)(dword_B32108 - v64) % 0x20;
      v65 = 0;
      v70 = 0;
      v67 = 0x20 - v18;
      do
      ...
      while ( v22 >= 0 );
      v24 = dword_B3210C - 1;
      v25 = dword_B3210C / 0x20;
      v65 = dword_B3210C / 0x20;
      v26 = &v60 + dword_B3210C / 0x20;
      v64 = 0x1F - dword_B3210C % 0x20;
      if ( ((1 << (0x1F - dword_B3210C % 0x20)) & *v26) != 0 )
      {
        for ( j = (~(0xFFFFFFFF << (0x1F - dword_B3210C % 0x20)) & *(&v60 + v25)) == 0; j; j = *(&v60 + v25) == 0 )
        {
          if ( ++v25 >= 3 )
            goto LABEL_52;
        }
...
LABEL_52:
      *v26 &= 0xFFFFFFFF << v64;
      if ( v65 + 1 < 3 )
        memset(&v60 + v65 + 1, 0, 4 * (3 - (v65 + 1)));
      v36 = (dword_B32110 + 1) / 0x20;
      v37 = (dword_B32110 + 1) % 0x20;
      v65 = 0;
      v72 = 0;
      v67 = 0x20 - v37;
      do
...
LABEL_79:
  ...
  if ( dword_B32114 == 0x40 )
  {
    v56 = v61;
    a2[1] = v55;
    *a2 = v56;
  }
  else if ( dword_B32114 == 0x20 )
  {
    *a2 = v55;
  }
  return result;
