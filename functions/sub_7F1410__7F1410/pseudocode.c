NiD3DShaderDeclaration **sub_7F1410()
{
  ...
  DX9ShaderDeclaration = CreateDX9ShaderDeclaration(dword_B43104, 4, 1u);
  ...
  v6 = (SpeedTreeLeafShader *)FormHeapAlloc(0x398u);
  if ( v6 )
    v7 = SpeedTreeLeafShader::SpeedTreeLeafShader(v6);
  else
    v7 = 0;
  (*(void (__thiscall **)(SpeedTreeLeafShader *))(*(_DWORD *)v7 + 0x84))(v7);
  (*(void (__thiscall **)(SpeedTreeLeafShader *))(*(_DWORD *)v7 + 0xA8))(v7);
  sub_7F09D0((NiD3DPass **)v7);
  (*(void (__thiscall **)(SpeedTreeLeafShader *))(*(_DWORD *)v7 + 0x88))(v7);
  shader = v1->shader;
