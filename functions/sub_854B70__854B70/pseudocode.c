NiTPointerList_Node_void *__thiscall sub_854B70(_DWORD *this, int a2, _WORD *a3, int a4, char *a5, char a6)
{
  int v7; // eax
  char *v8; // esi
  int v9; // eax
  ...
  if ( a6 )
  {
    if ( (_BYTE)a4 == 1 )
    {
      ...
      v8 = a5;
      if ( v7 )
        v9 = sub_7E2370(v7, a2, 0x18D, *a5, 0, 0);
      else
        v9 = 0;
LABEL_6:
      a4 = v9;
  ...
  else
  {
    if ( (_BYTE)a4 == 1 )
    {
      ...
      v8 = a5;
      if ( v12 )
        v9 = sub_7E2370(v12, a2, 0x18C, *a5, 0, 0);
      else
        v9 = 0;
      goto LABEL_6;
    }
