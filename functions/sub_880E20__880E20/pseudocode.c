void __thiscall sub_880E20(NiTArray_NiD3DPass *this, int a2, int a3, NiRenderedTexture *Stage, _DWORD *a5)
{
  ...
  int v26; // ebp
  NiRenderedTexture **v27; // ebx
  bool v28; // zf
  int v29; // ebx
  NiRenderedTexture *v30; // ebp
  ...
  v24 = *(_DWORD *)(*(_DWORD *)(v7 + 0x24) + 0x18);
  v25 = (NiRenderedTexture *)dword_B43108;
  v26 = *(_DWORD *)(v24 + 4);
  v27 = (NiRenderedTexture **)(v24 + 4);
  v28 = v26 == dword_B43108;
  ...
  v29 = *(_DWORD *)(*(_DWORD *)(v7 + 0x24) + 0x1C);
  v30 = *(NiRenderedTexture **)(v29 + 4);
  v28 = v30 == CanopySadowMap;
  v31 = CanopySadowMap;
  ...
  if ( !v28 )
  {
    ...
    *(_DWORD *)(v29 + 4) = v31;
    if ( v31 )
      InterlockedIncrement((volatile LONG *)&v31->member);
  }
  ++*(_DWORD *)(v7 + 0x60);
