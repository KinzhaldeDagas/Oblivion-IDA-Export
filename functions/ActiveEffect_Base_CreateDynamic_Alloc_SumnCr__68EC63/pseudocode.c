int __usercall ActiveEffect_Base_CreateDynamic_::Alloc_SumnCr@<eax>(
        int a1@<esi>,
        int a2,
        int a3,
        int a4,
        ...
        int a27)
{
  ...
  v27 = (SummonCreatureEffect *)FormHeapAlloc(0x64u);
  v30 = (int)v27;
  if ( !v27 )
    return ActiveEffect_Base_CreateDynamic_::Return_0(
             ...
             a25,
             0);
  v28 = SummonCreatureEffect::SummonCreatureEffect(v27, a24, a25, a1);
