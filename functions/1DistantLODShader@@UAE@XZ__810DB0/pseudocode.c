void __thiscall DistantLODShader::~DistantLODShader(BSShader *this)
{
  ...
  this->__vftable = (BSShaderVtbl *)&DistantLODShader::`vftable';
  v2 = (BSShader *)((char *)this + 0x8C);
  v3 = 4;
  do
  {
  ...
  *((_DWORD *)this + 0x2A) = 0;
  FormHeapFree(v7);
  _LN21((char *)this + 0x9C, 4u, 2, (void (__thiscall *)(void *))sub_7016A0);
  _LN21((char *)this + 0x8C, 4u, 4, (void (__thiscall *)(void *))sub_7016A0);
  _LN21(this + 1, 4u, 1, (void (__thiscall *)(void *))sub_4027D0);
