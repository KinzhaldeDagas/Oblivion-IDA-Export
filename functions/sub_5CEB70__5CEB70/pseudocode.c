void __userpurge sub_5CEB70(int a1@<ecx>, double st5_0@<st2>, double st6_0@<st1>, double a4@<st0>, int a5, int a6)
{
  ...
  if ( a5 == 5 )
  {
    ...
    Tile_GetFloat(*(_DWORD **)(a1 + 0x30), 0xFB0);
    ...
    sub_588CF0(*(_DWORD **)(a1 + 0x30));
    __asm { fsubr   [esp+18h+a3] }
    __asm { fstp    qword ptr [esp+1Ch+a3] }
    Tile_GetFloat(*(_DWORD **)(a1 + 0x30), 0xFCA);
    __asm
    {
    ...
    if ( __SETP__(HIBYTE(_AX) & 5, 0) )
    {
      ...
      __asm { fsubr   [esp+18h+a3] }
      __asm { fstp    qword ptr [esp+1Ch+a3] }
      Float = Tile_GetFloat((_DWORD *)*(_DWORD *)(a1 + 0x30), 0xFCA);
      __asm
      {
        fdivr   qword ptr [esp+18h+a3]
        fld1
...
LABEL_7:
        ...
        __asm { fstp    [esp+1Ch+a2]; a3 }
        Tile_SetFloat(*(Tile **)(a1 + 0x30), (_DWORD *)0xFB7, a2a);
        __asm { fldz }
        __asm { fstp    [esp+1Ch+a2]; a3 }
        Tile_SetFloat(*(Tile **)(a1 + 0x30), (_DWORD *)0xFB7, a2b);
        return;
      }
      __asm { fstp    st }
    }
