int __thiscall sub_6ED500(_DWORD *this, signed int a2)
{
  ...
  v4(v8, this + 3, 4, &a2, 1);
  v7 = v2[0x88];
  v5 = *(void (__cdecl **)(int, _DWORD *, int, signed int *, int))(v7 + 8);
  a2 = 4;
  v5(v7, this + 4, 4, &a2, 1);
  (*(void (__thiscall **)(_DWORD *, _DWORD))(*v2 + 0x2C))(v2, *(this + 5));
  return (*(int (__thiscall **)(_DWORD *, _DWORD))(*v2 + 0x2C))(v2, *(this + 6));
}
