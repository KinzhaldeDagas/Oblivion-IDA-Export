void __thiscall sub_83F8A0(NiTArray_NiD3DPass *this, int a2, int a3, NiRenderedTexture *Stage, _DWORD *a5)
{
  NiRenderedTexture *v6; // ebx
  NiD3DPass *v7; // edi
  int m_controller; // ebp
  _DWORD *v9; // ebx
  ...
  v23 = (NiRenderedTexture *)Texture->members.super.super.m_uiRefCount;
  ...
  if ( !v21 )
  {
    ...
    Texture->members.super.super.m_uiRefCount = (UInt32)v24;
    if ( v24 )
