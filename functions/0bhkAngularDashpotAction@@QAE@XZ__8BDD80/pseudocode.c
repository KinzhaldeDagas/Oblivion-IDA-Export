        ...
        int a2)
{
  ...
  if ( v4 )
  {
    ...
    ++dword_BA7D40;
    v5->__vftable = (NiObjectVtbl *)&bhkAngularDashpotAction::`vftable';
    ++dword_BA8064;
  }
  else
  {
  ...
  (*(void (__thiscall **)(bhkAngularDashpotAction *, bhkRefObject *, int))(*(_DWORD *)this + 0x88))(this, v5, a2);
  if ( dword_BA7CFC-- == 1 )
    dword_BA7CF8 = 0;
  LeaveCriticalSection(&stru_BA7C80);
  return (bhkAngularDashpotAction *)v5;
}
