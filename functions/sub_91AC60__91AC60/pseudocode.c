int __thiscall sub_91AC60(_DWORD *this, _DWORD *a2)
{
  const void **v2; // ebp
  _DWORD *v3; // edi
  _DWORD *v4; // eax
  ...
  *((_DWORD *)v2[0xC] + (_DWORD)v2[0xD]) = v3;
  ...
  v14 = 0;
  for ( j = 0; v14 < a2[0x12]; j = v14 )
  {
    v15 = *(_DWORD *)(a2[0x11] + 4 * v14);
    v16 = *(_DWORD *)(v15 + 0x38);
    v17 = (_DWORD *)(v15 + 0x34);
    v18 = 0;
    if ( v16 > 0 )
  ...
  for ( k = 0; k < result; ++k )
  {
    (*((void (__thiscall **)(const void **, _DWORD))v2[0xA] + 1))(v2 + 0xA, *(_DWORD *)(*v22 + 4 * k));
    result = v22[1];
  }
  return result;
}
