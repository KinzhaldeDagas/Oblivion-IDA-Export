LONG __thiscall sub_642BF0(_DWORD *this, LONG Comperand, int *a3, int *a4)
{
  ...
  while ( 1 )
  {
    while ( sub_43C070(this, Comperand, *a3) )
    {
      ...
      if ( (*(_DWORD *)((*(this + 6) & 0xFFFFFFFE) + 8) & 1) == 0 )
      {
        ...
        result = (*(int (__thiscall **)(_DWORD, _DWORD))(*(_DWORD *)*this + 0x24))(
                   *this,
                   *(_DWORD *)(*(this + 6) & 0xFFFFFFFE));
        *a3 = result;
        v6 = *a4;
        v7 = (int *)((*(this + 6) & 0xFFFFFFFE) + 4);
        if ( *a4 != *v7 )
        {
          if ( v6 )
          {
