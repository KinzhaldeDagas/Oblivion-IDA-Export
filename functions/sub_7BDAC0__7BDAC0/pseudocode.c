char __stdcall sub_7BDAC0(NiNode *a1)
{
  int **v1; // edi
  ...
  if ( NiPropertyByID )
  {
    ...
    {
      (*((void (__thiscall **)(NiProperty *, int **))NiPropertyByID->vtbl + 0x16))(NiPropertyByID, v1);
      return 1;
    }
  ...
  v4 = (SkyShaderProperty *)FormHeapAlloc(0x8Cu);
  if ( v4 )
    v5 = (BSShaderProperty *)SkyShaderProperty::SkyShaderProperty(v4);
  else
    v5 = 0;
