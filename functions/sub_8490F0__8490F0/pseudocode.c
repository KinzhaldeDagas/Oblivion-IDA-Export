void __thiscall sub_8490F0(NiTArray_NiD3DPass *this, int a2, int a3, int a4, NiD3DPass *a5)
{
  NiD3DPass *v6; // esi
  UInt32 Stage; // edi
  int v8; // eax
  ...
  _DWORD **v11; // edi
  int v12; // eax
  UInt32 v14; // [esp+28h] [ebp+8h]

  v6 = (NiD3DPass *)dword_B455AC;
  if ( a3 )
    sub_7AECB0(v6, (NiD3DVertexShader *)dword_B4530C[0]);
  else
    sub_7AECB0(v6, (NiD3DVertexShader *)dword_B45290[0]);
