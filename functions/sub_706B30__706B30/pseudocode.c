unsigned int __userpurge sub_706B30@<eax>(_DWORD *this@<ecx>, int a2@<ebp>, unsigned __int16 *a3)
{
  ...
  v5 = (unsigned __int16 *)TESOutput_PrintString(*(_DWORD *)dword_B3F988);
  end = v3->end;
  ...
  v8 = (unsigned __int16 *)TESOutput_PrintLabeledBool((int)"m_bWireframe", (char)a3);
  v9 = v3->end;
  a3 = v8;
  if ( v9 >= v3->capacity )
