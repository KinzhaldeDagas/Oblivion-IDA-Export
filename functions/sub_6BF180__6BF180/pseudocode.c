char __cdecl sub_6BF180(float a1, int *a2, int *a3)
{
  int *v3; // ebp
  int v4; // esi
  unsigned int v5; // ecx
  ...
  v3 = (int *)*a2;
  if ( !sub_6D31B0(a1, *a2, *a3, (int)&v13, 8) )
    return 0;
  v4 = *a3 + 1;
  ...
  {
    LODWORD(v12) = 8 * (*a3 - v13);
    memcpy(&v8[8 * v13 + 8], &v3[2 * v13], v12);
  }
  v14 = sub_6BB4D0(a1, (float *)v3, 1, *a3, 8u);
  v9 = (float *)&v8[8 * v13];
  *v9 = a1;
  v9[1] = v14;
  ++*a3;
