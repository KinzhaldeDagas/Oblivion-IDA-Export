void sub_839A50()
{
  ...
  v9 = dword_B45480;
  if ( VertexShader != (NiD3DVertexShader *)dword_B45480 )
  {
    if ( VertexShader )
    {
  ...
  v11 = dword_B45270;
  if ( PixelShader != (NiD3DPixelShader *)dword_B45270 )
  {
    if ( PixelShader )
    {
  ...
  v16 = v0->VertexShader;
  v17 = dword_B45484;
  if ( v16 != (NiD3DVertexShader *)dword_B45484 )
  {
    if ( v16 )
    {
  ...
  v18 = v0->PixelShader;
  v19 = dword_B45270;
  if ( v18 != (NiD3DPixelShader *)dword_B45270 )
  {
    if ( v18 )
    {
