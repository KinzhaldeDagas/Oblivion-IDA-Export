LockFreeMap *__thiscall sub_4BD050(LockFreeMap *this, unsigned int a2, unsigned int a3, UInt32 a4)
{
  void *v5; // eax
  void *v6; // edi
  ...
  this->vtbl = &LockFreeMap<unsigned int,NiPointer<DistantLODLoaderTask>>::`vftable';
