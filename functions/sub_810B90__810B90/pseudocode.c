...
LABEL_13:
  ...
  v8 = (SpeedTreeBranchShader *)FormHeapAlloc(0x134u);
  if ( v8 )
    v9 = (volatile LONG *)SpeedTreeBranchShader::SpeedTreeBranchShader(v8, v5);
  else
    v9 = 0;
  (*(void (__thiscall **)(volatile LONG *))(*v9 + 0x84))(v9);
  (*(void (__thiscall **)(volatile LONG *))(*v9 + 0xA8))(v9);
  (*(void (__thiscall **)(volatile LONG *))(*v9 + 0xB4))(v9);
  (*(void (__thiscall **)(volatile LONG *))(*v9 + 0xB8))(v9);
  (*(void (__thiscall **)(volatile LONG *))(*v9 + 0x88))(v9);
