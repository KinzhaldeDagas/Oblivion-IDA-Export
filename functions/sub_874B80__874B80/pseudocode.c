void __thiscall sub_874B80(NiTArray_NiD3DPass *this, int a2, int a3, int a4, NiD3DPass *a5)
{
  NiD3DPass *v6; // edi
  int v7; // ebx
  UInt32 Stage; // ebx
  ...
  v17 = v16->members.super.super.m_uiRefCount;
  ...
  if ( !v18 )
  {
    ...
    v16->members.super.super.m_uiRefCount = (UInt32)v19;
    if ( v19 )
