  ...
  if ( a2 != *(this + 4) )
  {
      ...
      if ( (unsigned __int16)a2 < v4 )
      {
        do
        {
          ...
          if ( *(_DWORD *)v6 )
          {
            ...
            if ( !InterlockedDecrement((volatile LONG *)(*(_DWORD *)v6 + 8)) )
            {
              if ( v7 )
                (**v7)(v7, 1);
            }
    ...
    *(this + 4) = a2;
    if ( a2 )
    {
      ...
      *((_DWORD *)this + 1) = v11;
      ...
      if ( !v13 )
      {
        do
        {
          ...
          if ( v16 != v24[v15] )
          {
            if ( v16 )
            {
              if ( !InterlockedDecrement((volatile LONG *)(v16 + 8)) )
                (**(void (__thiscall ***)(int, int))v16)(v16, 1);
            }
            v18 = v24[v15];
            *v17 = v18;
            if ( v18 )
              InterlockedIncrement((volatile LONG *)(v18 + 8));
          }
          v12 = ++v26;
        }
        while ( v26 < *(this + 5) );
      ...
      for ( i = *(this + 5); i < *(this + 4); ++i )
      {
        ...
        if ( v21 )
        {
          if ( !InterlockedDecrement((volatile LONG *)(v21 + 8)) )
    ...
    if ( v8 )
    {
      ...
      _LN21(v8, 4u, v8[0xFFFFFFFF], sub_4BDDC0);
      FormHeapFree(v23);
    }
  }
}
