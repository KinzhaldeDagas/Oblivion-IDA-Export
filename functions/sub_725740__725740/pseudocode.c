unsigned int __userpurge sub_725740@<eax>(float *this@<ecx>, int a2@<ebp>, NiTArray_NiTexturingPropertyMap *a3)
{
  ...
  v5 = TESOutput_PrintString(*(char **)dword_B3FD80);
  end = v3->end;
  ...
  v8 = TESOutput_PrintLabeledFloat("m_fAtten0", *(this + 0x42));
  v9 = v3->end;
  v10 = v3->capacity;
  ...
  v11 = TESOutput_PrintLabeledFloat("m_fAtten1", *(this + 0x43));
  v12 = v3->end;
  v13 = v3->capacity;
  ...
  v14 = TESOutput_PrintLabeledFloat("m_fAtten2", *(this + 0x44));
  v15 = v3->end;
  v16 = v3->capacity;
