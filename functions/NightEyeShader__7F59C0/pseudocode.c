NiD3DShaderDeclaration **NightEyeShader()
{
  ...
  v6 = (NighteyeShader *)FormHeapAlloc(0xC0u);
  if ( v6 )
    v7 = NighteyeShader::NighteyeShader(v6);
  else
    v7 = 0;
  v7->super.__vftable->super.Unk084((BSShader *)v7);
  ((void (__thiscall *)(NighteyeShader *))v7->super.__vftable[1].super.super.super.super.super.Destructor)(v7);
  v7->super.__vftable[1].super.super.super.super.GetType((NiShader *)v7);
  shader = (NighteyeShader *)v1->shader;
  if ( shader != v7 )
  {
    if ( shader )
    {
