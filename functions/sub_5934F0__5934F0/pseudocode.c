        ...
        int a7)
{
  ...
  if ( a6 == 0xC )
  {
    ...
    sub_588CF0(*(_DWORD **)(_ESI + 0x64));
    __asm { fsubr   qword ptr [esp+10h+a3] }
    __asm { fstp    qword ptr [esp+14h+a3]; a3 }
    Float = Tile_GetFloat((_DWORD *)*(_DWORD *)(_ESI + 0x64), 0xFB6);
    ...
    Tile_SetFloat(*(Tile **)(_ESI + 0x64), (_DWORD *)0xFB7, a2);
    __asm { fld     [esp+10h+arg_0] }
    v20 = Double_To_SInt32(Float);
    __asm { fild    [esp+10h+arg_0] }
    __asm { fstp    [esp+14h+a2]; a3 }
    Tile_SetFloat(*(Tile **)(_ESI + 0x64), (_DWORD *)0xFB7, a2a);
    __asm { fldz }
    __asm { fstp    [esp+14h+a2]; a3 }
    Tile_SetFloat(*(Tile **)(_ESI + 0x64), (_DWORD *)0xFB7, a2b);
  }
}
