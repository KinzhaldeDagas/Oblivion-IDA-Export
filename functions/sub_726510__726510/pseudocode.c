int __thiscall sub_726510(char *this, signed int a2)
{
  ...
  v2 = a2;
  v16 = *(_DWORD *)(a2 + 0x21C);
  v4 = *(void (__cdecl **)(int, char *, int, signed int *, int))(v16 + 4);
  a2 = 4;
  v4(v16, this + 4, 4, &a2, 1);
  v14 = *(_DWORD *)(v2 + 0x21C);
  v5 = *(void (__cdecl **)(int, char *, int, signed int *, int))(v14 + 4);
  a2 = 4;
  v5(v14, this + 8, 4, &a2, 1);
  v13 = *(_DWORD *)(v2 + 0x21C);
  v6 = *(void (__cdecl **)(int, char *, int, signed int *, int))(v13 + 4);
  a2 = 4;
  v6(v13, this + 0xC, 4, &a2, 1);
  v12 = *(_DWORD *)(v2 + 0x21C);
  v7 = *(void (__cdecl **)(int, char *, int, signed int *, int))(v12 + 4);
  a2 = 4;
  v7(v12, this + 0x10, 4, &a2, 1);
  v17 = *(_DWORD *)(v2 + 0x21C);
  v8 = *(void (__cdecl **)(int, char *, int, signed int *, int))(v17 + 4);
  a2 = 4;
  v8(v17, this + 0x14, 4, &a2, 1);
  v15 = *(_DWORD *)(v2 + 0x21C);
  v9 = *(void (__cdecl **)(int, char *, int, signed int *, int))(v15 + 4);
  a2 = 4;
  v9(v15, this + 0x18, 4, &a2, 1);
  v10 = *(_DWORD *)(v2 + 0x21C);
  a2 = 1;
  return (*(int (__cdecl **)(int, char *, int, signed int *, int))(v10 + 4))(v10, this, 1, &a2, 1);
}
