unsigned __int8 *__thiscall TESContainer_GetBestClothingForSlot(_DWORD *this, int *a2, int a3)
{
  _DWORD *v3; // edi
  ...
  if ( this != (_DWORD *)0xFFFFFFF8 )
  {
    do
    {
      if ( *v3 )
      {
        ...
        if ( v6 )
        {
          if ( a3 != 0xFFFFFFFF && TESBipedModelForm_CoversSlot((unsigned __int16 *)v6 + 0x2E, a3, 0) )
          {
